...
public class GcmIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (!extras.isEmpty()) {  // has effect of unparcelling Bundle
            ...
            if (GoogleCloudMessaging.MESSAGE_TYPE_SEND_ERROR.equals(messageType)) {
                //sendNotification(GoogleCloudMessaging.MESSAGE_TYPE_SEND_ERROR, extras);
                
            } else if (GoogleCloudMessaging.MESSAGE_TYPE_DELETED.equals(messageType)) {
                //sendNotification(GoogleCloudMessaging.MESSAGE_TYPE_DELETED, extras);
            ...
            // If it's a regular GCM message, do some work.
            	...
            	//
                //Hiển thị phía trên màn hình (notify)
                //Post notification of received message.
                sendNotification(GoogleCloudMessaging.MESSAGE_TYPE_MESSAGE, extras);
    ...
    //Hiển thị ở ngoài PUSH (notification phía trên màn hình)
    // Put the message into a notification and post it.
    // This is just one simple example of what you might choose to do with
    // a GCM message.
    private void sendNotification(String state, Bundle extras) {
