...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    CCScene *pScene = TestPostGetScene::scene(); //  ScoreScene::scene(); // IntroScene::scene(); // MenuScene::scene();// TestPostGetScene::scene(); // NotLoggedInMenuScene::scene();// IntroScene::scene(); // MenuScene::scene(); // IntroScene::scene(); //
